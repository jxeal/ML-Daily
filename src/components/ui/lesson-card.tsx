...
export const LessonCard = memo(function LessonCard({
  ...
  return (
    <Link href={`/lessons/${lesson.id}`} className="block group">
      <div className="bg-card rounded-3xl p-5 border border-white/5 relative overflow-hidden transition-colors duration-300 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1">
